...
// update Event
export const updateEvent = (event) => update(url.UPDATE_EVENT, event);
...
// update order
export const updateOrder = (order) => update(url.UPDATE_ORDER, order);
...
export const updateCustomer = (customer) =>
  update(url.UPDATE_CUSTOMER, customer);
...
// update user
export const updateUser = (user) => update(url.UPDATE_USER, user);
...
// update jobs
export const updateJobList = (job) => update(url.UPDATE_JOB_LIST, job);
...
// update user
export const updateProject = (project) => update(url.UPDATE_PROJECT, project);
